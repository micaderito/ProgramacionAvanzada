...
hombre(jorge,baja,castaño,joven).
...
mujer(julia,alta,castaño,media).
mujer(pepa,alta,castaño,media).
...
busca(jose,media,castaño,adulta).
busca(pedro,alta,castaño,media).
busca(sergio,baja,negro,vieja).
busca(luisa,media,castaño,adulta).
